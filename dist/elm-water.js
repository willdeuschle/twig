...
var _user$project$Simplify$parseGoodSentenceIds = F2(
	function (dict, num) {
...
var _user$project$Simplify$genHits = F2(
...
var _user$project$Simplify$countSentenceScore = F3(
	function (lst, sent, title) {
		var title_boost = 2 * A2(
			_user$project$Simplify$genHits,
			_elm_lang$core$String$words(title),
			sent);
		var raw_score = A2(_user$project$Simplify$genHits, lst, sent);
		return _elm_lang$core$Basics$toFloat(raw_score + title_boost) / _elm_lang$core$Basics$toFloat(
			1 * _elm_lang$core$List$length(
				_elm_lang$core$String$words(sent)));
	});
var _user$project$Simplify$annotateSentences = F3(
	function (sent_lst, word_lst, title) {
		return A3(
			_elm_lang$core$List$foldl,
			function (_p4) {
				var _p5 = _p4;
				return A2(
					...
					_p5._0,
					A3(_user$project$Simplify$countSentenceScore, word_lst, _p5._1, title));
			},
			_elm_lang$core$Dict$empty,
...
var _user$project$Simplify$genGoodSentenceIds = F2(
	function (str, title) {
		var sentLst = _user$project$Simplify$genSentenceList(str);
		return A2(
			_user$project$Simplify$parseGoodSentenceIds,
			A3(
...
var _user$project$Simplify$genGoodSentenceList = F2(
	function (str, title) {
		var sentLst = _user$project$Simplify$genSentenceList(str);
		return A2(
			_user$project$Simplify$attachSentencesFromIds,
			A2(_user$project$Simplify$genGoodSentenceIds, str, title),
			sentLst);
	});
var _user$project$Simplify$simplify = F2(
	function (str, title) {
		return A2(_user$project$Simplify$genGoodSentenceList, str, title);
	});

var _user$project$Highlight$indivSent = F3(
	function (sent, idx, ids) {
		return A2(_elm_lang$core$List$member, idx, ids) ? A2(
			_elm_lang$html$Html$mark,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(
					A2(_elm_lang$core$Basics_ops['++'], sent, ' '))
				])) : A2(
...
var _user$project$Highlight$highlight = F2(
	function (str, title) {
		var ids = A2(_user$project$Simplify$genGoodSentenceIds, str, title);
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('article-text')
				]),
			A2(
				_elm_lang$core$List$map,
				function (_p0) {
					var _p1 = _p0;
					return A3(_user$project$Highlight$indivSent, _p1._1, _p1._0, ids);
				},
				_elm_lang$core$Array$toIndexedList(
...
var _user$project$App$initialView = function (model) {
	var spiel2 = 'To use the project, paste a url from a Medium article into the search bar. For example: https://medium.com/the-starbucks-collection/coffee-and-wine-ed058b0dc6ed#.1lhz7h3uo';
	var spiel1 = 'Hello! I developed this project to learn more about the Elm programming language. To view its source, or run the project locally, head over to: ';
	return _elm_lang$core$String$isEmpty(model.title) ? A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(spiel1),
				A2(
				_elm_lang$html$Html$a,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('github-link'),
						_elm_lang$html$Html_Attributes$href('https://github.com/willdeuschle/twig')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('https://github.com/willdeuschle/twig')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('sub-description')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(spiel2)
					]))
			])) : A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
...
var _user$project$App$initModel = {url: '', simplifiedText: '', articleText: '', title: ''};
		...
		switch (_p0.ctor) {
			...
			case 'GetArticle':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{title: 'Loading...', simplifiedText: ''}),
					_1: _user$project$App$getArticle(model.url)
				};
			case 'ArticleReceived':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							title: _p1.title,
							simplifiedText: A2(_user$project$Simplify$simplify, _p1.article, _p1.title),
							articleText: _p1.article
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return _p0._0 ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{title: 'Sorry, that url is currently non-functional.'}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$App$articleReceived = _elm_lang$core$Native_Platform.incomingPort(
	'articleReceived',
	A2(
		...
		function (title) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'article', _elm_lang$core$Json_Decode$string),
				function (article) {
					return _elm_lang$core$Json_Decode$succeed(
						{title: title, article: article});
				});
		}));
var _user$project$App$articleStatus = _elm_lang$core$Native_Platform.incomingPort('articleStatus', _elm_lang$core$Json_Decode$bool);
var _user$project$App$Model = F4(
	function (a, b, c, d) {
		return {url: a, simplifiedText: b, articleText: c, title: d};
	});
var _user$project$App$ArticlePayload = F2(
	function (a, b) {
		return {title: a, article: b};
	});
var _user$project$App$ArticleStatus = function (a) {
	return {ctor: 'ArticleStatus', _0: a};
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$App$articleStatus(_user$project$App$ArticleStatus)
			]));
};
...
var _user$project$App$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('top-level')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Medium Simplifier')
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('url-container')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$placeholder('Enter the Medium article url here...'),
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('simplify-button'),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('article-container')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_user$project$App$initialView(model),
								A2(
								_elm_lang$html$Html$br,
								_elm_lang$core$Native_List.fromArray(
									[]),
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('simplified-text')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(model.simplifiedText)
									])),
								A2(_user$project$Highlight$highlight, model.articleText, model.title)
							]))
					]))
			]));
};
