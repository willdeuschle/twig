...
var _user$project$App$initModel = {url: '', simplifiedText: '', title: ''};
			...
			case 'ArticleReceived':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							title: _p1.title,
							simplifiedText: _user$project$Simplify$simplify(_p1.article)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return _p0._0 ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{title: 'Sorry, that url is not currently working.'}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _user$project$App$articleFailed = _elm_lang$core$Native_Platform.incomingPort('articleFailed', _elm_lang$core$Json_Decode$bool);
var _user$project$App$Model = F3(
	function (a, b, c) {
		return {url: a, simplifiedText: b, title: c};
	});
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$App$articleFailed(_user$project$App$ArticleStatus)
			]));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('text-container')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
